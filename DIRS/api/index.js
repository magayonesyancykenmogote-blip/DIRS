...
// Route parser - parse incoming URL
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`[API] ${req.method} ${req.url} -> resource: ${resource}, id: ${id}, action: ${action}`);
    ...
    // No route matched
    res.status(404).json({ error: 'Not found', path: req.url, resource, id, action });
  } catch (error) {
